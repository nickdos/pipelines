 ...
 */
public class CompoundPredicate implements org.gbif.api.model.occurrence.predicate.Predicate {

  @NotNull
  private final Collection<org.gbif.api.model.occurrence.predicate.Predicate> predicates;

  @JsonCreator
  protected CompoundPredicate(@JsonProperty("predicates") Collection<org.gbif.api.model.occurrence.predicate.Predicate> predicates) {
